...
void luaRegister_Properties()
{
    ...
    sc->registerClass("Properties", lua_members, NULL, lua_Properties__gc, lua_statics, scopePath);
}
...
static Properties* getInstance(lua_State* state)
{
    ...
    return (Properties*)((ScriptController::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        ...
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TSTRING)
            {
                ...
                object->instance = (void*)instance->getNamespace(param1);
                object->owns = false;
        ...
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TBOOLEAN)
            {
                ...
                Properties* instance = getInstance(state);
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)instance->getNamespace(param1, param2);
                object->owns = false;
                luaL_getmetatable(state, "Properties");
                lua_setmetatable(state, -2);
    ...
    switch (paramCount)
    {
        case 1:
        {
            if (lua_type(state, 1) == LUA_TUSERDATA)
            {
                Properties* instance = getInstance(state);
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)instance->getNextNamespace();
                object->owns = false;
                luaL_getmetatable(state, "Properties");
                lua_setmetatable(state, -2);
    ...
    switch (paramCount)
    {
        case 1:
        {
            if (lua_type(state, 1) == LUA_TSTRING)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)Properties::create(param1);
                object->owns = false;
                luaL_getmetatable(state, "Properties");
                lua_setmetatable(state, -2);
