...
static const char* luaEnumString_TextureCubeFace_NOT_A_FACE = "NOT_A_FACE";
...
Texture::CubeFace lua_enumFromString_TextureCubeFace(const char* s)
{
    ...
    if (strcmp(s, luaEnumString_TextureCubeFace_NOT_A_FACE) == 0)
        return Texture::NOT_A_FACE;
    return Texture::POS_X;
}
...
const char* lua_stringFromEnum_TextureCubeFace(Texture::CubeFace e)
{
    ...
    if (e == Texture::NOT_A_FACE)
        return luaEnumString_TextureCubeFace_NOT_A_FACE;
