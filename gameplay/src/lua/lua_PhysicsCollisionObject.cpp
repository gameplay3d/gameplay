...
void luaRegister_PhysicsCollisionObject()
{
    ...
    sc->registerClass("PhysicsCollisionObject", lua_members, NULL, lua_PhysicsCollisionObject__gc, lua_statics, scopePath);
}
...
static PhysicsCollisionObject* getInstance(lua_State* state)
{
    ...
    return (PhysicsCollisionObject*)((ScriptController::LuaObject*)userdata)->instance;
}
