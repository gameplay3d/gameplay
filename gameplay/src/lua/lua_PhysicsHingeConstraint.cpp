...
void luaRegister_PhysicsHingeConstraint()
{
    ...
    sc->registerClass("PhysicsHingeConstraint", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsHingeConstraint* getInstance(lua_State* state)
{
    ...
    return (PhysicsHingeConstraint*)((ScriptController::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                object->instance = (void*)new Vector3(PhysicsHingeConstraint::centerOfMassMidpoint(param1, param2));
                object->owns = true;
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Quaternion(PhysicsHingeConstraint::getRotationOffset(param1, *param2));
                object->owns = true;
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector3(PhysicsHingeConstraint::getTranslationOffset(param1, *param2));
                object->owns = true;
                luaL_getmetatable(state, "Vector3");
                lua_setmetatable(state, -2);
