...
void luaRegister_RenderStateStateBlock()
{
    ...
    sc->registerClass("RenderStateStateBlock", lua_members, NULL, lua_RenderStateStateBlock__gc, lua_statics, scopePath);
}
...
static RenderState::StateBlock* getInstance(lua_State* state)
{
    ...
    return (RenderState::StateBlock*)((ScriptController::LuaObject*)userdata)->instance;
}
...
int lua_RenderStateStateBlock_static_create(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 0:
        {
            ...
            object->instance = (void*)RenderState::StateBlock::create();
            object->owns = false;
