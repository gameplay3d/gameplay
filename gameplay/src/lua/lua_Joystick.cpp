...
void luaRegister_Joystick()
{
    const luaL_Reg lua_members[] = 
    {
        ...
        {"getAutoSize", lua_Joystick_getAutoSize},
        ...
        {"setAutoSize", lua_Joystick_setAutoSize},
...
int lua_Joystick_getAutoSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_Joystick_getAutoSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_Joystick_setAutoSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_Joystick_setAutoSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
