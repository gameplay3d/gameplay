...
void luaRegister_Vector4()
{
    ...
    sc->registerClass("Vector4", lua_members, lua_Vector4__init, lua_Vector4__gc, lua_statics, scopePath);
}
...
static Vector4* getInstance(lua_State* state)
{
    ...
    return (Vector4*)((ScriptController::LuaObject*)userdata)->instance;
}
...
int lua_Vector4__init(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 0:
        {
            ...
            object->instance = (void*)new Vector4();
            object->owns = true;
        ...
        case 1:
        {
            if ((lua_type(state, 1) == LUA_TTABLE || lua_type(state, 1) == LUA_TLIGHTUSERDATA))
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector4(param1);
                object->owns = true;
                luaL_getmetatable(state, "Vector4");
                lua_setmetatable(state, -2);
            ...
            {
                // Get parameter 1 off the stack.
                void* userdata1 = ScriptController::getInstance()->getObjectPointer(1, "Vector4");
                if (!userdata1)
                {
                    lua_pushstring(state, "Failed to retrieve a valid object pointer of type 'Vector4' for parameter 1.");
                    lua_error(state);
                }
                Vector4* param1 = (Vector4*)((ScriptController::LuaObject*)userdata1)->instance;
        ...
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                Vector4* param2 = (Vector4*)((ScriptController::LuaObject*)userdata2)->instance;

                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector4(*param1, *param2);
                object->owns = true;
                luaL_getmetatable(state, "Vector4");
                lua_setmetatable(state, -2);
        ...
        case 4:
        {
                ...
                lua_type(state, 4) == LUA_TNUMBER)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector4(param1, param2, param3, param4);
                object->owns = true;
                luaL_getmetatable(state, "Vector4");
                lua_setmetatable(state, -2);
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TUSERDATA)
            {
                ...
                Vector4* param3 = (Vector4*)((ScriptController::LuaObject*)userdata3)->instance;
    ...
    switch (paramCount)
    {
        case 4:
        {
                ...
                lua_type(state, 4) == LUA_TUSERDATA)
            {
                ...
                Vector4* param4 = (Vector4*)((ScriptController::LuaObject*)userdata4)->instance;
    ...
    switch (paramCount)
    {
        case 1:
        {
            if (lua_type(state, 1) == LUA_TNUMBER)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector4(Vector4::fromColor(param1));
                object->owns = true;
                luaL_getmetatable(state, "Vector4");
                lua_setmetatable(state, -2);
...
int lua_Vector4_static_one(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::one());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
...
int lua_Vector4_static_unitW(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::unitW());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
...
int lua_Vector4_static_unitX(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::unitX());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
...
int lua_Vector4_static_unitY(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::unitY());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
...
int lua_Vector4_static_unitZ(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::unitZ());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
...
int lua_Vector4_static_zero(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        {
            ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
            object->instance = (void*)&(Vector4::zero());
            object->owns = false;
            luaL_getmetatable(state, "Vector4");
            lua_setmetatable(state, -2);
