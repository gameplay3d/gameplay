    ...
    switch (paramCount)
    {
        ...
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                Vector4* param2 = ScriptController::getInstance()->getObjectPointer<Vector4>(2, "Vector4", true);
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 3 off the stack.
                Vector4* param3 = ScriptController::getInstance()->getObjectPointer<Vector4>(3, "Vector4", false);
    ...
    switch (paramCount)
    {
        case 4:
        {
                ...
                (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TNIL))
            {
                ...
                // Get parameter 3 off the stack.
                Vector4* param3 = ScriptController::getInstance()->getObjectPointer<Vector4>(3, "Vector4", true);

                // Get parameter 4 off the stack.
                Vector4* param4 = ScriptController::getInstance()->getObjectPointer<Vector4>(4, "Vector4", false);
