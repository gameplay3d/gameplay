...
void luaRegister_PhysicsGenericConstraint()
{
    ...
    sc->registerClass("PhysicsGenericConstraint", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsGenericConstraint* getInstance(lua_State* state)
{
    ...
    return (PhysicsGenericConstraint*)((ScriptController::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector3(PhysicsGenericConstraint::centerOfMassMidpoint(param1, param2));
                object->owns = true;
                luaL_getmetatable(state, "Vector3");
                lua_setmetatable(state, -2);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Quaternion(PhysicsGenericConstraint::getRotationOffset(param1, *param2));
                object->owns = true;
                luaL_getmetatable(state, "Quaternion");
                lua_setmetatable(state, -2);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TUSERDATA)
            {
                ...
                ScriptController::LuaObject* object = (ScriptController::LuaObject*)lua_newuserdata(state, sizeof(ScriptController::LuaObject));
                object->instance = (void*)new Vector3(PhysicsGenericConstraint::getTranslationOffset(param1, *param2));
                object->owns = true;
                luaL_getmetatable(state, "Vector3");
                lua_setmetatable(state, -2);
