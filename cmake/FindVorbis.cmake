...
_FIND_VORBIS_LIBRARY(VORBIS_FILE_LIBRARY        vorbisfile)
_FIND_VORBIS_LIBRARY(VORBIS_FILE_LIBRARY_DEBUG  vorbisfile_Debug vorbisfile_d)

# handle the QUIETLY and REQUIRED arguments and set VORBIS_FOUND to TRUE if 
# all listed variables are TRUE
include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Vorbis DEFAULT_MSG
    VORBIS_LIBRARY VORBIS_FILE_LIBRARY 
    VORBIS_INCLUDE_DIR)

set(VORBIS_INCLUDE_DIRS ${VORBIS_INCLUDE_DIR})
if(VORBIS_FOUND)
   _VORBIS_APPEND_LIBRARIES(VORBIS_LIBRARIES VORBIS_LIBRARY)
   _VORBIS_APPEND_LIBRARIES(VORBIS_LIBRARIES VORBIS_FILE_LIBRARY)
endif()
