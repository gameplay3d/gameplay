...
void BillboardTest::keyEvent(Keyboard::KeyEvent evt, int key)
{
...
bool BillboardTest::mouseEvent(Mouse::MouseEvent evt, int x, int y, int wheelDelta)
{
    switch (evt)
    {
...
void BillboardTest::loadGround()
{
	// Just a basic plane for this test
