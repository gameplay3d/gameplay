...
void WaterSample::gamepadEvent(Gamepad::GamepadEvent evt, Gamepad* gamepad)
{
    ...
    case Gamepad::BUTTON_EVENT:
        (_gamepad->isButtonDown(Gamepad::BUTTON_A)) ? _inputMask |= Button::Forward : _inputMask &= ~Button::Forward;
        (_gamepad->isButtonDown(Gamepad::BUTTON_B)) ? _inputMask |= Button::Back : _inputMask &= ~Button::Back;
        break;
